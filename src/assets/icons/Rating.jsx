const Rating = ({color, fill}) => {
    ...
    return ( 
        <svg className="hover:fill-Theme hover:strole-Theme" width="24" height="24" viewBox="0 0 24 24" fill={fill} xmlns="http://www.w3.org/2000/svg">
